...
import { DISPLAY_MODE_OPTIONS, DisplayMode, loadDisplayMode, normalizeDisplayMode, saveDisplayMode } from "../services/renderMode";
import { loadUserConfigMigratingLocalStorage, normalizeTheme, savePreviewModeConfig, saveRenderDisplayModeConfig, saveThemeConfig } from "../services/userConfig";
...
export function SettingsPage({ theme, setTheme }: any) {
  ...
  const resetConfigDir = async () => {
    ...
    setLog("用户配置目录已恢复默认 AppData，并迁移当前配置。");
  };
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 12, height: "100%", overflow: "auto" }}>
      ...
      <div className="group-box">
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          <button className="btn" onClick={resetConfigDir}>恢复默认 AppData</button>
